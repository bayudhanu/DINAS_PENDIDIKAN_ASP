        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    { path: 'kelas', loadChildren: () => import('./modules/components/kelas/kelas.module').then(m => m.KelasModule) },
                    { path: 'siswa', loadChildren: () => import('./modules/components/siswa/siswa.module').then(m => m.SiswaModule) },
